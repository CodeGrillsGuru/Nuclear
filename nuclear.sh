...
echo -e "$red                      ▶ Coded by$grn GuruGroverTECH$red ◀$rset"
echo -e "$red                 ⫸$ylo instagram:vrushabh9423$red ⫷$rset"
echo 
# Functions
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [1️⃣] Create Virus"
...
echo " "
echo -e "$cyan            click$grn ENTER$cyan to go back into main  menu$rset"
echo " "
read punch
fi
cd $HOME/Infect/
